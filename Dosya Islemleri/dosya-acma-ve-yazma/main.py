...
Yani, eğer açmak istediğimiz dosyadan zaten varsa ve dosyanın içi doluysa "w" kipi dosyadaki bilgileri silip tekrar oluşturacaktır.
(Biraz Tehlikeli)
"""
...
"""
ğer bir dosyayı bulunduğumuz dizinde değil de başka bir dizinde açmak istersek, dizinin yolunu özellikle belirtmeliyiz.

(Windows işletim sistemi kullanıyorum. 
Başka işletim sistemleri için yapamazsanız bana ulaşabilirsiniz :) )
"""
